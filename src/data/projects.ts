...
export const projects: Project[] = [
  {
    ...
    title: "CareerTrack",
    description:
      "AI-powered career assistant platform helping users navigate their professional journey.",
    image:
  ...
  },
  {
    ...
    longDescription:
      "An advanced Learning Management System that optimized backend performance, achieving a 25% reduction in API response time during stress testing, ensuring seamless operation under high-load conditions. The platform features course management, student progress tracking, and interactive learning materials.",
  ...
  },
  {
    ...
    title: "HRMS",
    description:
      "A comprehensive Human Resource Management System with AI capabilities.",
    image:
  ...
  },
  {
    ...
    title: "HealthCare+",
    description:
      "A comprehensive healthcare patient management system with appointment booking.",
    image:
      "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?q=80&w=2070&auto=format&fit=crop",
    technologies: ["Next.js", "React", "Node.js", "MongoDB"],
    longDescription:
      "HealthCare+ is a full-featured healthcare management system that streamlines the patient experience. It includes features for appointment booking, management, and SMS notifications. The platform helps both patients and healthcare providers manage their schedules efficiently.",
...

  {
    ...
    title: "Music School",
    description:
      "A modern music school website built with Next.js and TypeScript.",
    image:
    ...
    longDescription:
      "A beautifully designed music school website that showcases courses, instructors, and facilities. Built with Next.js and TypeScript, featuring a modern UI powered by Acertinity UI components.",
...

  {
    ...
    title: "Blog Website",
    description:
      "A full-featured blog platform using Appwrite backend and React.js frontend.",
    image:
    ...
    longDescription:
      "A modern blog platform that combines the power of Appwrite as a backend service with React.js and Vite for the frontend. The website features a clean, responsive design implemented with Tailwind CSS, making it both beautiful and functional.",
    githubUrl: "https://github.com/sahil-1610/AppwriteBlogWebsite",
    liveUrl: "https://sahiltiwariblog.netlify.app/",
  },
  {
    id: 7,
    title: "PlayTube",
    description: "A Youtube like Platform.",
    image:
      "https://images.unsplash.com/photo-1717295248494-937c3a5655b1?q=80&w=2128&auto=format&fit=crop",
    ...
    liveUrl: "https://play-tube-ten.vercel.app/",
    githubUrl: "https://github.com/sahil-1610/PlayTube",
  },
  {
    id: 8,
    title: "AI QUIZ",
    description: "An AI Pdf to Quiz Generator.",
    image:
      "https://images.unsplash.com/photo-1606326608606-aa0b62935f2b?q=80&w=2070&auto=format&fit=crop",
    technologies: ["Next.js", "Vercel", "Gemini"],
    longDescription:
      "Upload a PDF to generate an interactive quiz based on its content using the AI SDK and Google's Gemini Pro.",
    liveUrl: "https://ai-pdf-to-quiz-generator.vercel.app/",
    githubUrl: "https://github.com/sahil-1610/ai-pdf-to-quiz-generator",
  },
];
